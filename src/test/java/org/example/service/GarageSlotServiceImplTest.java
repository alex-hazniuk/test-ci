...
public class GarageSlotServiceImplTest {
    ...
    @Test
    public void saveSingleGarageSlot() {
    ...
    @Test
    public void testSaveMultipleGarageSlots() {
        garageSlotService.save();
        garageSlotService.save();
        List<GarageSlot> savedSlots = garageSlotService.getAll();
    ...
    @Test
    public void getAllWithMultipleSlots() {
    ...
    @Test
    public void getAllAfterRemovingSlots() {
        GarageSlot garageSlot1 = new GarageSlot(1, GarageSlotStatus.AVAILABLE);
        GarageSlot garageSlot2 = new GarageSlot(2, GarageSlotStatus.UNAVAILABLE);
        garageSlotRep.add(garageSlot1);
        garageSlotRep.add(garageSlot2);
    ...
    @Test
    public void sortedByStatusWithSingleSlot() {
    ...
    @Test
    public void sortedByStatusWithMultipleSlotsSameStatus() {
    ...
    @Test
    public void sortedByStatusWithMixedStatusSlots() {
    ...
    @Test
    public void testChangeStatusFromAvailableToUnavailable() {
        int id = 1;
    ...
    @Test
    public void testChangeStatusFromUnavailableToAvailable() {
        int id = 2;
        GarageSlot initialGarageSlot = GarageSlot.builder()
                .id(id)
    ...
    @Test
    public void findByIdExistingSlot() {
        GarageSlot g1 = new GarageSlot(1, GarageSlotStatus.AVAILABLE);
        garageSlotRep.add(g1);
    ...
    @Test
    public void findByIdNonExistingSlot() {
        assertThrows(InvalidIdException.class, () -> garageSlotService.findById(100));
    }

    @Test
    public void findByIdWithMultipleSlots() {
    ...
    @Test
    public void testFindByIdNonExistingSlotWithExceptionMessage() {
